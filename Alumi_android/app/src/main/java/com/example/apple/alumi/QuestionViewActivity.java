                    ...
                    new AlertDialog.Builder(QuestionViewActivity.this)
                            ...
                            .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent intent = new Intent(QuestionViewActivity.this, ArticlesListActivity.class);
    ...
    public void mOnClick(View v){
        switch(v.getId()){
            ...
            case R.id.btnEdit:  //게시글 수정 버튼
                Intent intent = new Intent(QuestionViewActivity.this, ArticleEditActivity.class);
